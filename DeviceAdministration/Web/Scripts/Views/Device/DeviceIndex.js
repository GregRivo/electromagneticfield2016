    ...
    var _initializeDatatable = function() {
        ...
        self.dataTable = self.dataTableContainer.DataTable({
            ...
            "columns": [
                ...
                {
                    "data": "DeviceProperties.BatteryLevel",
                    "mRender": function (data) {
                        return htmlEncode(data);
                    },
                    "name": "batteryLevel"
                ...
                {
                    "data": "DeviceProperties.BatteryVoltage",
                    "mRender": function (data) {
                        return htmlEncode(data);
                    },
                    "name": "batteryVoltage"
                ...
                {
                    "data": "DeviceProperties.Temperature",
                    "mRender": function (data) {
                        return htmlEncode(data);
                    },
                    "name": "temperature"
                ...
                {
                    "data": "DeviceProperties.Latitude",
                    "mRender": function (data) {
                        return htmlEncode(data);
                    },
                    "name": "latitude"
                ...
                {
                    "data": "DeviceProperties.Longitude",
                    "mRender": function (data) {
                        return htmlEncode(data);
                    },
                    "name": "longitude"
