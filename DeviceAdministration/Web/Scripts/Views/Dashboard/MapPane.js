        ...
        if (deviceLocations) {
            for (i = 0 ; i < deviceLocations.length; ++i) {
                ...
                pinOptions = {
                    ...
                    text: "Battery Level: " + deviceLocations[i].batteryLevel +
                        "<br />Battery Voltage: " + deviceLocations[i].batteryVoltage +
                        "<br />Temperature: " + deviceLocations[i].temperature,
                    textOffset: new Microsoft.Maps.Point(25, 25),
                    height: 17,
                    width: 17,
