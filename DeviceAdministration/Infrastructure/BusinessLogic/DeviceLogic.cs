        ...
        public DeviceListLocationsModel ExtractLocationsData(List<dynamic> devices)
        {
            ...
            foreach (dynamic device in devices)
            {
                ...
                try
                {
                    ...
                    batteryLevel = DeviceSchemaHelper.GetDeviceProperties(device).BatteryLevel;
                    batteryVoltage = DeviceSchemaHelper.GetDeviceProperties(device).BatteryVoltage;
                    temperature = DeviceSchemaHelper.GetDeviceProperties(device).Temperature;
                }
